      ...
      <main class="grid grid-cols-1 md:grid-cols-12 md:grid-rows-6 gap-0 min-h-screen">
        ...
        <section class="col-span-1 md:col-span-8 md:row-span-4 bg-neutral-900 relative overflow-hidden flex items-end p-8 md:p-12 border-b md:border-b-0 md:border-r border-white/10 min-h-[500px]">
          ...
          <div class="absolute inset-0 z-0">
            <img src="https://images.unsplash.com/photo-1600185365483-26d7a4cc7519?auto=format&fit=crop&q=80&w=1920" class="w-full h-full object-cover opacity-30 mix-blend-luminosity" referrerpolicy="no-referrer">
          </div>

          <div class="absolute top-10 left-10 z-20 flex flex-col gap-2">
          ...
          <div class="z-20 w-full flex flex-col md:flex-row justify-between items-start md:items-end gap-8 mt-40">
            <div class="max-w-[300px]">
              ...
              <a routerLink="/shop" class="inline-block bg-accent text-black px-8 py-4 font-black text-sm uppercase tracking-widest hover:bg-white transition-colors">Shop Collection</a>
            </div>
        ...
        <!-- PROMO (Col 4, Row 3) -->
        <section class="col-span-1 md:col-span-4 md:row-span-3 bg-accent text-black p-8 md:p-10 flex flex-col justify-between border-b border-black min-h-[300px]">
        ...
        @for (product of trendingProducts(); track product.id) {
          <section class="col-span-1 md:col-span-3 md:row-span-2 border-r border-b md:border-b-0 border-white/10">
